...
class Arena(Base):
    ...
    cords: Mapped[JSON] = mapped_column(JSON, nullable=True, default=None)
...
class Match(Base):
    ...
    new_things_player1: Mapped[JSON] = mapped_column(JSON, nullable=True, default=None)
    ...
    new_things_player2: Mapped[JSON] = mapped_column(JSON, nullable=True, default=None)
